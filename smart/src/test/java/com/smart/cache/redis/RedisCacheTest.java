...
public class RedisCacheTest {
    ...
    public void test() {
        ...
        Cache<String, String> cache = cacheManager.getCache("redis");
    ...
    public void test2() {
        SmartCacheManager cacheManager = new RedisCacheManager();
        Cache<Integer, Integer> cache = cacheManager.getCache("one");
    ...
    public void testRemove(){
        SmartCacheManager cacheManager = new RedisCacheManager();
        Cache<Object, Object> cache = cacheManager.getCache("xxx");
    ...
    public void testSerializable2(){
        SmartCacheManager cacheManager = new RedisCacheManager();
        Cache<String, Person> cache = cacheManager.getCache("person");
    ...
    public void testSerializable3(){
        SmartCacheManager cacheManager = new RedisCacheManager();
        Cache<String, List<Person>> cache = cacheManager.getCache("person");
