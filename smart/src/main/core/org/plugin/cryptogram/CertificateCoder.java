...
/**
 * 我们需要构建一个由CA机构签发的有效证书，这里我们使用上文中生成的自签名证书zlex.cer <br>
 * 这里，我们将证书导入到我们的密钥库。 <br>
 * @author 梁栋
 * @version 1.0
 * @since 1.0
 */
public abstract class CertificateCoder extends Cryptogram {
