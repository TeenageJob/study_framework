...
/**
 * Exception thrown due to a problem with the account under which an
 * authentication attempt is being executed.
 *
 * @since 0.1
 */
public class AccountException extends AuthenticationException {
	...
	/**
	 * create by ty on TY 
	 * <br>2017年12月15日 上午9:56:25
	 */
	private static final long serialVersionUID = -1084274220422593130L;
