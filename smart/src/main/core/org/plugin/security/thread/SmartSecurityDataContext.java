package org.plugin.security.thread;
 ...
 * 
 * @author TY
 * @Time 2018年1月10日 下午4:11:42
 * @since 1.0.0
 */
public class SmartSecurityDataContext {
	/**
	 * 使每个线程拥有各自的 DataContext 实例
	 */
	private static final ThreadLocal<SmartSecurityDataContext> dataContextContainer = new ThreadLocal<SmartSecurityDataContext>();
	...
	public static void init(HttpServletRequest request) {
		SmartSecurityDataContext smartSecurityDataContext = new SmartSecurityDataContext();
		smartSecurityDataContext.request = request;
		dataContextContainer.set(smartSecurityDataContext);
	}
	 ...
	 * 获取 DataContext 实例
	 */
	public static SmartSecurityDataContext getInstance() {
	...
	private static boolean isStaticFile(String url) {
		if (url.equals("") || url.contains("www/") 
				|| url.contains("js") 
				|| url.contains("css") 
				|| url.contains("jsp")
				|| url.contains("html")
