...
public class DatabaseHelper {
     ...
     * 根据 SQL 语句查询指定字段列表（多条记录）
     */
    public static Set<String> queryColumnSet(String sql, Object... params) {
        return dataAccessor.queryColumnSet(sql, params);
    }
    ...
    public static int executeSql(String sql, Object... params) {
        return dataAccessor.executeSql(sql, params);
    }

    /**
     * 执行sql，返回List结果
     */
    public static <T> List<T> executeSqlList(String sql, Object... params) {
        return dataAccessor.executeSqlList(sql, params);
    }

    /**
     * 执行sql，返回List结果
     */
    public static <T> List<List<T>> executeList(String sql, Object... params) {
        return dataAccessor.executeList(sql, params);
    }

    /**
     * 执行sql，返回List结果
     */
    public static <T> List<Map<T, Map<String, Object>>> executeColumnMap(String column, String sql, Object... params) {
        return dataAccessor.executeColumnMap(column, sql, params);
    }
}
