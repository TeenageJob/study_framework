...
public class StringUtil {
	 ...
	 *
	 * <br>
	 * create by on TY 2017年11月4日 下午5:06:09
	 * 
	 * @param str
	 *            传入字符串
	 * @return String 小写字母
	 ...
	 * @return
	 */
	public static String getFixLength(String str,int number){
		int pointIndex=str.indexOf(".")+number+1;
